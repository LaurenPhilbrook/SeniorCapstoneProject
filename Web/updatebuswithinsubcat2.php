...
<html lang="en">
<head>
	<title>Add Businesses to a Subcategory</title>
	<meta charset="utf-8">
...
<body>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Add Businesses to a Subcategory</h1>
                </div>
			<div class="row">
                <div class="col-lg-12">
...
$url2 = "http://www.recycling-app-13.appspot.com/business";
				...
				for($i = 0; $i < $length2; $i++) {
					$counter = 0;
					for($x=0; $x < $length; $x++) {
						if(strcmp($info2[$i]["id"], $info["businesses"][$x]["id"]) == 0) {
							$x = $length;
						} else {
						$counter ++;
						}
...
if(isset($_POST["submit"])) {
	...
	foreach ($bus as $busid) {
		//ADD BUS TO SUBCAT WITHIN DATABASE
		$curl = curl_init();
