...
<html lang="en">
<head>
	<title>Remove Subcategories within a Category</title>
	<meta charset="utf-8">
...
<body>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Remove Subcategories within Category</h1>
                </div>
			<div class="row">
                <div class="col-lg-12">
...
$catName = $_POST["catName"]; 
 echo "Subcategories within " . $catName;
...
$url = "http://www.recycling-app-13.appspot.com/category/" . $catid;
				...
				//var_dump($info);
				for($i = 0; $i < $length; $i++) {
					echo "<input type='checkbox' name='subcat[]' id='subcat' value='" . $info["subcategories"][$i]["id"] . "' checked='true'> " . $info["subcategories"][$i]["name"];
					/*echo count($info["subcategories"]);
...
if(isset($_POST["submit"])) {
	...
	foreach ($subcat as $subcatid) {
		//REMOVE SUBCAT FROM CAT WITHIN DATABASE
		
		
		// /category/catid/subcategory/id
		$curl = curl_init();
