API is hosted on Google App Engine (GAE). A tutorial for GAE is found here: https://cloud.google.com/appengine/docs/python/gettingstartedpython27/introduction
API is in python, upload all code to GAE and use the endpoints below to make calls. 
